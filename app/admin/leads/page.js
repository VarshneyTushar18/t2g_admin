    ...
    async function initTable() {
      ...
      table = $("#leadTable").DataTable({
        ...
        columnDefs: [
          ...
          { responsivePriority: 1, targets: 8 }, // Actions
          ...
          { responsivePriority: 7, targets: 6 }, // Form Type
          { responsivePriority: 8, targets: 7 }, // Source Page
          { responsivePriority: 9, targets: 5 }, // Message (collapse first)
        ],
      });
    }
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .dataTables_wrapper .dataTables_length,
          .data7bles_wrapper .dataTables_filter {
