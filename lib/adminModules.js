...
export const MODULE_SECTIONS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Career Agent", href: "/admin/career/agent" },
      { label: "Job Approvals", href: "/admin/career/approvals" },
    ],
  },
  {
    key: "life",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Auto blogs", href: "/admin/blog/agent-automations" },
      { label: "Image Agent", href: "/admin/blog/image-agent" },
    ],
  },
  {
    key: "blog_2_0",
    label: "Blog-2.0",
    href: "/admin/blog-2.0",
    description: "Bright CRM — AI blog + MailerLite",
    icon: "🚀",
    match: (path) =>
      path === "/admin/blog-2.0" || path.startsWith("/admin/blog-2.0/"),
    children: [
      { label: "Overview", href: "/admin/blog-2.0" },
      { label: "Setup checklist", href: "/admin/blog-2.0/setup" },
      { label: "MailerLite", href: "/admin/blog-2.0/mailerlite" },
      { label: "Drafts", href: "/admin/blog-2.0/drafts" },
      { label: "Blog Agent", href: "/admin/blog-2.0/agent" },
      { label: "Automations", href: "/admin/blog-2.0/automations" },
    ],
  },
  {
    key: "connect",
    ...
    children: [
      { label: "API Keys", href: "/admin/connect" },
      { label: "AI Integrations", href: "/admin/connect/ai" },
    ],
  },
];
